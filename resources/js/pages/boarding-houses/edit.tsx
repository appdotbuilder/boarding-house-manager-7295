...
export default function EditBoardingHouse({ boardingHouse }: Props) {
    const { data, setData, put, processing, errors } = useForm<BoardingHouseFormData>({
        name: boardingHouse.name,
        address: boardingHouse.address,
        number_of_rooms: boardingHouse.number_of_rooms,
        owner: boardingHouse.owner,
        contact: boardingHouse.contact,
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('boarding-houses.update', boardingHouse.id));
    };
    ...
    return (
        <AppLayout>
            ...
            <div className="p-6 max-w-2xl mx-auto">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold">✏️ Edit Boarding House</h1>
                    <p className="text-muted-foreground">Update boarding house information</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Boarding House'}
                        </Button>
                    </div>
                </form>
            </div>
